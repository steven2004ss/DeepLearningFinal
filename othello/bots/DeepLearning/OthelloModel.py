...
class OthelloModel():
    ...
    def save_weights(self):
        self.model.save_weights('C:\Users\steve\Downloads\0106\othello\bots\DeepLearning\models'+self.model_name)
    
    def load_weights(self):
        self.model.load_weights('C:\Users\steve\Downloads\0106\othello\bots\DeepLearning\models'+self.model_name)
    ...
    def reset(self, confirm=False):
        if not confirm:
            ...
            try:
                os.remove('C:\Users\steve\Downloads\0106\othello\bots\DeepLearning\models'+self.model_name)
            except:
                pass
        print('cleared')
